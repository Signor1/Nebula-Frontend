            ...
            <main className="w-full lg:py-44 md:py-32 py-24 px-6 grid md:grid-cols-2 lg:gap-4 md:gap-8 gap-12">
                ...
                <div className="w-full">
                    <form className="w-full ">
                        ...
                        <button className=" text-[#0f161b] uppercase font-bold tracking-[1px] px-[30px] py-3.5 border-[none] bg-[#45f882]  font-Barlow hover:bg-[#ffbe18] clip-path-polygon-[100%_0,100%_65%,89%_100%,0_100%,0_0]">Submit Now</button>
                    </form>
                </div>
            </main>
        </section>
